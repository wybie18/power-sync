            ...
            <form action="{{ route('user.results.index') }}" method="GET" class="flex flex-wrap gap-4">
                <div class="flex-1 min-w-[200px]">
                    ...
                    <select name="quiz_id" id="quiz_id"
                        class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:  id="quiz_id"
                ...
                <div class="flex items-end">
                    ...
                    @if (request()->hasAny(['quiz_id', 'alignment', 'date_range']))
                        ...
                        @foreach ($results as $result)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $result->alignment === 'hero' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200' }}">
